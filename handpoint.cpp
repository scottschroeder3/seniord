...
{ }
                                         ￼￼￼￼￼￼￼void XN_CALLBACK_TYPE Hand_Destroy(xn::HandsGenerator& generator,
                                                                                   ...
                                                                                   void* pCookie)
{
    printf("Lost Hand: %d\n", nId); g_GestureGenerator.AddGesture(GESTURE_TO_USE, NULL);
}
                                         ￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼void main() {
                                             ...
                                             nRetVal = g_GestureGenerator.Create(context); nRetVal = g_HandsGenerator.Create(context); // TODO: check error code
                                             // Register to callbacks
                                             XnCallbackHandle h1, h2;
                                             ￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼￼g_GestureGenerator.RegisterGestureCallbacks(Gesture_Recognized, Gesture_Process,
                                                                                                                          NULL, h1); g_HandsGenerator.RegisterHandCallbacks(Hand_Create, Hand_Update,
                                                                                                                                                                            ￼￼￼￼￼￼￼￼Hand_Destroy, NULL, h2);
                                             ￼￼￼￼// Start generating
                                             nRetVal = context.StartGeneratingAll(); // TODO: check error code
